...
public class InputReferenceTest3 extends student.TestCase {
    ...
    public void testMain2() {
        ...
        assertFuzzyEquals(
                "Output not as expected for input files "
    ...
    /**
     * Test the program with the class survey data from 6 students about only 5
     * songs. Gathers the output from StdOut and compares it to the expect
     * output as stored in Output1TitleGenreHobby.txt
     * 
     */
